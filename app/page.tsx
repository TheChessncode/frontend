...
export const metadata: Metadata = genMeta({
  ...
  description: 'Chessncode transforms strategic thinking from the chessboard into computational thinking for the digital world. Empowering 1 million girls and women by 2035 through chess and coding education.',
  keywords: [
    'chess and coding',
    'girls in tech',
    'women in coding',
